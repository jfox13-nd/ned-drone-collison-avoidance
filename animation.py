...
# def animate_wave_points(my_points):
#     ''' perform animation of the wave dance '''
...
#     ax.set_ylim(int(min(alt_points))-1, 10 + int(max(alt_points)))
#     ax.set_xlim(int(min(lon_points))-1,1+ int(max(lon_points)))
